---
title: "Indicadores Educacionais: Curso Técnico Integrado em Eletrotécnica"
description: |
  Estatísticas educacionais do Curso Técnico Integrado em Eletrotécnica
...
```{r, eval = TRUE, message = FALSE, warning = FALSE, preview = TRUE}
