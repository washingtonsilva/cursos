---
title: "Indicadores Educacionais: Licenciatura em Matemática"
description: |
  Estatísticas educacionais da Licenciatura em Matemática
...
```{r, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, preview = TRUE}

p13 <- ggplot(data = Matematica, aes(x = periodo_letivo, y = matriculas_iniciais, group = curso)) + geom_point() + geom_line() 
...
p14 <- ggplot(data = Matematica, aes(x = periodo_letivo, y = concluintes, group = curso)) + geom_point() + geom_line() 
...
p15 <- ggplot(data = Matematica, aes(x = periodo_letivo, y = trancamento, group = curso)) + geom_point() + geom_line() 
...
p16 <- ggplot(data = Matematica, aes(x = periodo_letivo, y = retidos, group = curso)) + geom_point() + geom_line() 
...
p17 <- ggplot(data = Matematica, aes(x = periodo_letivo, y = evasao, group = curso)) + geom_point() + geom_line() 
...
p18 <- ggplot(data = Matematica, aes(x = periodo_letivo, y = taxa_evasao, group = curso)) + geom_point() + geom_line() 
