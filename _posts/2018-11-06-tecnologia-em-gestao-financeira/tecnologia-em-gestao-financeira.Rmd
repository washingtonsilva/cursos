---
title: "Indicadores Educacionais: Superior de Tecnologia em Gestão Financeira"
description: |
  Estatisticas educacionais do Superior de Tecnologia em Gestão Financeira
...
p13 <- ggplot(data = Gfin, aes(x = periodo_letivo, y = matriculas_iniciais, group = curso)) + geom_point() + geom_line() 
...
p14 <- ggplot(data = Gfin, aes(x = periodo_letivo, y = concluintes, group = curso)) + geom_point() + geom_line() 
...
p15 <- ggplot(data = Gfin, aes(x = periodo_letivo, y = trancamento, group = curso)) + geom_point() + geom_line() 
...
p16 <- ggplot(data = Gfin, aes(x = periodo_letivo, y = retidos, group = curso)) + geom_point() + geom_line() 
...
p17 <- ggplot(data = Gfin, aes(x = periodo_letivo, y = evasao, group = curso)) + geom_point() + geom_line() 
...
p18 <- ggplot(data = Gfin, aes(x = periodo_letivo, y = taxa_evasao, group = curso)) + geom_point() + geom_line() 
